...
import {Configuration, SECRET, SettingsDefinition, SettingsType, TAG_REGEXP} from '../sources/Configuration';

const initConfigurationPlugin = async (configuration: {[coreSettingName: string]: SettingsDefinition}) => {
